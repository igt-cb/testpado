...
@font-face
{
    ...
    src: local("Roboto Regular"), url('DXR_23.axd');
}
@font-face
{
    font-family: "Roboto Medium";
    src: local("Roboto Medium"), url('DXR_22.axd');
}
/* CheckBox */
...
.dxICBFocused_DefaultTheme .dxSwitcher::after
{
    ...
    width: 36px;
    height: 36px;
    background-color: rgba(25,33,80,0.3);
    border-radius: 50%;
...
{
    border-bottom: 3px solid #192150;
    text-transform: uppercase;
    font: 12px 'Segoe UI', Helvetica, 'Droid Sans', Tahoma, Geneva, sans-serif;font-weight:bold;
    font-size: 1em;
}
...
{
    background: url('DXR_12.axd') repeat;
    font-size: 0;
    line-height: 0px;
}
...
.dxtvControl_DefaultTheme.dxtvRtl .dxtv-elb
{
    background-image: url('DXR_9.axd');
}
...
{
    width: 3px;
    background: url('DXR_7.axd') repeat-y right;
    border-width: 0px;
}
...
{
    background-image: url('DXR_11.axd');
...
.dxigItem_DefaultTheme
{
    background-repeat: no-repeat;
    background-position: center center;
    background-image: url('DXR_6.axd');
}
...
{
    width: 43px;
    background: url('DXR_8.axd') repeat-y;
}
.dxigControl_DefaultTheme .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
{
    margin: auto;
    background-image: url('DXR_14.axd');
    height: 30px;
    width: 30px;
}
...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('DXR_3.axd');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('DXR_13.axd');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('DXR_15.axd');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('DXR_10.axd');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
    background-image: url('DXR_16.axd');
    background-size: 1px 20px;
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem_DefaultTheme
{
    background-image: url('DXR_17.axd');
    background-size: 1px 10px;
}
.dxeTBVSys .dxeTBItem_DefaultTheme
{
    background-image: url('DXR_21.axd');
    background-size: 20px 1px;
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem_DefaultTheme
{
    background-image: url('DXR_25.axd');
...
{
    box-shadow: inset 0 0 0 2px #0E132E;
}
...
{
    box-shadow: inset 0 0 0 1px #0E132E;
}
